          ...
          <div>
            ...
            {queryParams.get("from") && queryParams.get("to") && (
              <p className="text-gray-600">
                <span className="font-medium">{queryParams.get("from")}</span>{" "}
                to <span className="font-medium">{queryParams.get("to")}</span>
                ...
                {queryParams.get("passengers") && (
                  <>
                    ...
                    ·{" "}
                    <span>
                      {queryParams.get("passengers")} passenger
                      {parseInt(queryParams.get("passengers") || "1") > 1
                        ? "s"
                        : ""}
                    </span>
                  </>
                    ...
                    <div className="flex-grow p-6">
                      <div className="flex flex-col md:flex-row justify-between mb-4">
                        ...
                        <div className="flex flex-col items-end">
                          <Badge
                            className={`mb-2 ${getBusTypeColor(schedule.bus)}`}
                          >
                            {schedule.bus}
                          </Badge>
